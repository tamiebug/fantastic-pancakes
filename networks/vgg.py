...
class VGG():
    def __init__(self, namespace="vgg"):
        ...
        self.vgg19LayerNames = [ 'conv1_1', 'relu1_1', 'conv1_2', 'relu1_2', 'pool1',
    ...
    def makeLayout(self, name):
        ...
        if name is "VGG16":
            for layerName in self.vgg19LayerNames:
                if layerName is 'conv3_4' or layerName is 'conv4_4' or layerName is 'conv5_4'\
    ...
    def buildGraph(self, prevLayer, train=False, train_starting_at=None, 
        ...
        with easy_scope(self.namespace, reuse=True):
            ...
            for layer in layout:
                with tf.device(layer["device"]) as dev:
